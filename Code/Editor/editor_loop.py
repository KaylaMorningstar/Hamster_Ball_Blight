...
class EditorSingleton():
    def __init__(self, Render, Screen, gl_context, PATH):
        ...
        self.collision_selector_modes = {'no_collision': CollisionSelector(Render, text_color=self.collision_selector_text_color, color=COLORS['WHITE'], text='NO COLLISION', text_pixel_size=self.collision_selector_text_pixel_size, mode=CollisionMode.NO_COLLISION),
                                         ...
                                         'grappleable': CollisionSelector(Render, text_color=self.collision_selector_text_color, color=COLORS['RED'], text='GRAPPLE', text_pixel_size=self.collision_selector_text_pixel_size, mode=CollisionMode.GRAPPLEABLE),
