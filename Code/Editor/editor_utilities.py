...
class LassoTool(EditorTool):
    ...
    def __init__(self, active: bool):
        ...
        self.bottomest_pixel: int | None = None
        # image while drawing the lasso outline
        self.lasso_outline: pygame.Surface | None = None
        super().__init__(active)
            ...
            match currently_pressed_character, int(self.current_tool):
                ...
                case None, LassoTool.INDEX:
                    ...
                    if (self.current_tool.state == LassoTool.NOT_LASSOING) and keys_class_instance.editor_primary.newly_pressed and cursor_on_map:
                        ...
                        self.current_tool.bottomest_pixel = None
                    ...
                    try:
                        match self.current_tool.state:
                            ...
                            case LassoTool.LASSOING:
                                update_lasso_outline_image = False
                                max_tile_x, max_tile_y = self.tile_array_shape[0] - 1, self.tile_array_shape[1] - 1
                                current_xy_position_on_map = (pos_x, pos_y)
                ...
                case None, BlurTool.INDEX:
                    ...
                    match self.current_tool.state:
                        ...
                        case BlurTool.BLURRING:
                            ...
                            outline_left, outline_top = pos_x - ((self.current_tool.blur_size - 1) // 2), pos_y - ((self.current_tool.blur_size - 1) // 2)

                            for (blur_offset_x, blur_offset_y) in self.current_tool.blur_circle_true_indexes:
                                if map_edit.get(tile_name := (edited_pixel_x := leftest_blur_pixel+blur_offset_x, edited_pixel_y := topest_blur_pixel+blur_offset_y)) is None:
